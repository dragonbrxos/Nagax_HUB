...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/dragonbrxos/Nagax_HUB/main/Scripts/Manual.lua"))()
```
...
| Módulo | Descrição |
| :--- | :--- |
| **Smart Orchestrator** | Sistema de IA que alterna automaticamente entre Farm, Itens e Eventos de Mar. |
| **Auto Farm** | Suporte completo para World 1, 2 e 3 com detecção automática de nível e quests. |
| **Sea Events** | Automação para Sea Beasts, Terrorsharks, e eventos de mar (incluindo Kitsune Island). |
| **Fruit System** | Sniper de frutas na loja, Auto-Buy, Auto-Eat e notificação de spawn de frutas. |
| **Auto Stats** | Distribuição automática de pontos em Melee, Defense, Sword, Gun ou Fruit. |
| **Race V4** | Assistência completa para Trials e evolução da raça para o nível máximo. |
...
> **Aviso:** Este script é destinado apenas para fins educacionais e de demonstração. O uso de scripts em jogos pode resultar em punições na sua conta. Use por sua conta e risco.
