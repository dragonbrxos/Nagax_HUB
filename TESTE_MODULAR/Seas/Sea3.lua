...
-- ── Criação das tabs ──────────────────────────────────────────
local Set        = NagaxLib:Tab("Settings Farm")
local Main       = NagaxLib:Tab("Auto Farm")
local Farm       = NagaxLib:Tab("Item Quest")
local Event      = NagaxLib:Tab("Mar Event")
local Stats      = NagaxLib:Tab("Auto Stats")
local Tele       = NagaxLib:Tab("World Tele")
local Player     = NagaxLib:Tab("Player Pvp")
local Race       = NagaxLib:Tab("Race V4")
local Raid       = NagaxLib:Tab("Dungeon Raid")
local DemonFruit = NagaxLib:Tab("Fruit Demon")
local Esp        = NagaxLib:Tab("Esp Player")
local Shop       = NagaxLib:Tab("Shopee")
local Misc       = NagaxLib:Tab("Miscellaneous")
